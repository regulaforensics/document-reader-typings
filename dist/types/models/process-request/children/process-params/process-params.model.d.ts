import { eDocFormat, eLogLevel, eMeasureSystem, eMRZFormat, eResult, eScenario, eTextPostProcessing, eVisualFieldType } from '../../../../consts';
import { FaceApi, iFaceApi, iImageQA, ImageQA, iPerDocumentConfig, iProcessParamsRfid, PerDocumentConfig, ProcessParamsRfid } from './children';
/**
...
* Processing parameters
*/
export declare class ProcessParams implements iProcessParams {
    /**
    * The list of LCID types to recognize. If empty, values with all LCID types will be extracted.
    * Empty by default.
    * @type {number[]|undefined}
