 ...
 *  }
 */
export type uDocVisualExtendedField = DocVisualExtendedField1 | DocVisualExtendedField2

/**
 * Union of all possible variants of DocVisualExtendedField in plain object form.
 */
export type iuDocVisualExtendedField = iDocVisualExtendedField1 | iDocVisualExtendedField2
 ...
 */
export const transformToDocVisualExtendedFieldList = (list: unknown[]): uDocVisualExtendedField[] =>
  list.map((item) => transformToDocVisualExtendedField(item))
 ...
 * @returns {uDocVisualExtendedField}
 */
export const transformToDocVisualExtendedField = (item: unknown): uDocVisualExtendedField => {
  if (isObject(item)) {
    if (Object.prototype.hasOwnProperty.call(item, 'RFID_OriginDG')) {
